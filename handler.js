      ...
      try {
         ...
         try {
            ...
            if (chat) {
               ...
               if (!('antiviewonce' in chat)) chat.viewonce = false
         ...
         if (!m.fromMe && !isROwner && setting.self) return
         if (m.chat.endsWith('g.us') && setting.pconly) return
         if (!m.chat.endsWith('g.us') && setting.grouponly) return
