module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = 'Rinz AI'
      if (!('toxic' in setting)) setting.toxic = ['jancok', 'bajingan']
      if (!('owners' in setting)) setting.owners = ['6281284760551']
      ...
      if (!('cover' in setting)) setting.cover = 'https://i.pinimg.com/originals/d1/1e/20/d11e20d44501e1a59439b5344e07f5d7.jpg'
      if (!('link' in setting)) setting.link = 'https://list-api.eu.org'
   } else {
      global.db.setting = {
         anticall: true,
         chatbot: false,
         ...
         owners: ['6281284760551'],
         msg: 'Hi  bot masih dalam pengembangan agar bot bisa selalu aktif yuk donasi terimakasih.',
         style: 1,
         cover: 'https://i.pinimg.com/originals/d1/1e/20/d11e20d44501e1a59439b5344e07f5d7.jpg',
         link: 'https://list-api.eu.org'
      }
   }
}